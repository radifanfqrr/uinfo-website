    ...
    <header class="py-1 bg-light border-bottom mb-1">
        <div class="container">
            <div class="text-center my-5">
                <h1 class="fw-bolder">Selamat Datang di UINFO</h1>
                <p class="lead mb-0">Tempat Informasi UIN Maliki Malang</p>
            </div>
        </div>
    </header>
    <!-- Page content-->
                    ...
                    if ($featured_result->num_rows > 0) {
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-primary" href="blogpost.php?id=<?= $featured_row['id_artikel'] ?>">Read more →</a>
                            </div>
                        </div>
                        <?php
                    }
